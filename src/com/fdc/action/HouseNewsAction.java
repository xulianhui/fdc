...
public class HouseNewsAction {
	...
	public String execute() throws IOException{
		String email=ActionContext.getContext().getSession().get("useremail").toString();
		...
		if (image != null) {
			for (int i= 0;i < image.size(); i++) {
				File savefile = new File(new File(realpath), System.currentTimeMillis()+housenews.getUserId()+imageFileName.get(i));
